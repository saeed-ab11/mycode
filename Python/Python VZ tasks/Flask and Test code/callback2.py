...
#                              'resultCode','resultReason','finishTime'),(),'Upgrade finished notification result'],
#           'upgradeFinished':[('notificationType','accountName','participantName','firmwareName','upgradeId','deviceList'),
#                          ('imei','status')]
#           }

my_dict={ '/newFirmware': [('notificationType', 'accountName', 'participantName', 'firmwareList'),
                          ('firmwareName', 'participantName', 'launchDate',
                           'releaseNote', 'model', 'make', 'fromVersion','toVersion'),"New firmware notification result"],
          '/upgradeStarted':[('notificationType','accountName','participantName','firmwareName','upgradeId',
